package github.hotstu.fireworks;/* -*- mode: java; c-basic-offset: 2; indent-tabs-mode: nil -*- */
...
public class PVector implements Serializable {
     ...
     * @return the random PVector
     */
    static public PVector random2D(PContext parent) {
     ...
     * @return the random PVector
     */
    static public PVector random3D(PContext parent) {
     ...
     * @return the random PVector
     */
    static public PVector random3D(PVector target, PContext parent) {
        float angle;
        float vz;
        if (parent == null) {
